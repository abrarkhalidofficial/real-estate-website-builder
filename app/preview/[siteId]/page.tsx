    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border bg-surface sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-gradient">Preview Your Website</h1>
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="bg-white">
            ...
            <div className="p-12 bg-white">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  <h2 className="text-3xl font-bold mb-2 text-gray-900">Luxury Villa in Paradise</h2>
                  <p className="text-2xl text-orange-500 font-bold mb-6">$2,500,000</p>
                  ...
                  <p className="text-gray-600 mb-6">
                    This stunning villa offers breathtaking views and world-class amenities. Perfect for luxury living.
                  </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="bg-white rounded-lg overflow-hidden shadow">
                    ...
                    <div className="p-4">
                      <h3 className="font-semibold text-gray-900 mb-2">Property {i}</h3>
                      <p className="text-orange-500 font-bold mb-2">$1,200,000</p>
                      <p className="text-sm text-gray-600">3 bed • 2 bath • 4,500 sqft</p>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
          <Card className="bg-surface border-border p-6">
            ...
            <p className="text-muted text-sm mb-4">luxuryvilla.realestate.ai</p>
            <Button variant="outline" className="w-full border-border hover:bg-surface bg-transparent text-sm">
              Copy Link
            </Button>
          </Card>
          ...
          <Card className="bg-surface border-border p-6">
            ...
            <p className="text-primary font-semibold mb-4">{isPublished ? "Published" : "Draft"}</p>
            <Button variant="outline" className="w-full border-border hover:bg-surface bg-transparent text-sm">
              View Analytics
            </Button>
          </Card>
