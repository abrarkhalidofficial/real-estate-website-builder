    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12">
          ...
          <p className="text-muted">Follow these steps to build your professional real estate website</p>
        </div>
        ...
        <Card className="bg-surface border-border p-8 mt-8">
          ...
          {currentStep === "content" && <ContentUpload onNext={handleNext} onBack={handleBack} />}
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center p-4 bg-input rounded-lg">
                    ...
                    <span className="font-semibold">{selectedPages.length} selected</span>
                  </div>
                </div>
              </div>
              ...
              {currentStep !== "review" && (
                <Button
                  ...
                  disabled={
                    ...
                    (currentStep === "pages" && selectedPages.length === 0)
                  }
